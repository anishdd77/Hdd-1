...
client.on('guildCreate', guild => {
  let support = client.guilds.get(569227403763908618) // حط هنا ايدي سيرفر السبورت
  if(support === undefined) return
  let role = support.roles.find(r => r.name == '『Bad』 -•Online-•') // بدلها بأسم الرتبة يلي تبيها للمستخدمين
